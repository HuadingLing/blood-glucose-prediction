...
n_past = [6,12,18,24,30,36] #长度<=7
LSTM_states = [8,16,32,64,128,256]

#True_id = [5,9,11,12]

def main(yaml_filepath, mode):
    rmse_list = []
    for pid in [4, 8, 11, 13, 18]: # 5,9,10,11,12,14,18,19,20,24,29,30,32,33,35
        patient_true_id = true_id[pid-1]
        rmse_result = []
        output_image_dir = "output_image/pic_2/patient_"+str(patient_true_id)+"/"
